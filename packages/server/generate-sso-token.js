...
const AES_KEY = Buffer.from('65bdd00e4d45dfea7d64a0e253f068ae8ad370f9130feca9a14e47a5e746c989', 'hex');
...
if (runFile === __filename) {
  ...
  console.log(`http://your-domain.com/sso-login?token=${result.token}\n`);
  console.log('========================================\n');
}
