...
export const workbenchRoute = '/workbench'
export const workbenchPendingReviewsRoute = '/workbench/reviews'
export const progressRoute = '/progress'
export const qualityAcceptanceRoute = '/quality-acceptance'
export const workValuationRoute = '/work-valuation'
export const archivesRoute = '/archives'
export const projectsRoute = '/projects'
export const loginRoute = '/authn/login'
export const registerRoute = '/authn/register'
export const ssoLoginRoute = '/authn/sso'
export const tokenLoginRoute = '/authn/token-login'
